...
def intro():
    print(f"Welcome to Texas Hold Em Game - Offline Edition! \n You are starting with this much Dollars: {bank}")
...
def mainPlayerActions(allPlayersWages):
    mainPlayerAction = input("Enter what action you would like to perform: 1:Fold, 2:Call, 3:Raise: " )
...
# 3. Deal cards then send to func 2
#
